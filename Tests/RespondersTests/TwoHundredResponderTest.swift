...
class TwoHundredResponderTest: XCTestCase {
  ...
  // CRUD functionality
    func testItCanDeliverContentsWithoutExtension() {
      ...
      XCTAssertEqual(response.body!.toBytes, "I'm a file".toBytes)
    }
    ...
    func testItCanCreateNewDataWithPost() {
      ...
      XCTAssertEqual(response.body!.toBytes, "cheese".toBytes)
    }
    ...
    func testItCanUpdateExistingRouteDataWithPut() {
      ...
      XCTAssertEqual(response.body!.toBytes, "updated cheese".toBytes)
    }
    ...
    func testItCanUpdateExistingDataWithPatch() {
      ...
      XCTAssertEqual(response.body!.toBytes, "new cheese".toBytes)
    }
  ...
  // Edge cases
    func testItCanUpdateNonExistingData() {
      ...
      XCTAssertEqual(getResponse.body!.toBytes, "updated cheese".toBytes)
    }
    ...
    func testItDoesNotAppendAdditionalDataToImage() {
      ...
      XCTAssertEqual(response.body!.toBytes, "this is an image file".toBytes)
    }
}
